...
- Proportieregel: de stelligheid van je taal schaalt mee met de grootte van het verschil. Kleiner dan 10 punten: behandel het terloops, als klein verschil. Tussen 10 en 20 punten: schrijf er stellig over. Boven 20 punten: geef de volle analyse. Deze indeling kalibreert alleen jouw toon; voor de lezer bestaan de indeling, haar grenzen en haar termen niet. Neem termen als "accent", "patroon" of "gat" dus niet als etiket over, zeg nooit wat iets niet is in classificatietermen ("geen patroon", "geen kloof") en toets nooit aan een grens ("wat als duidelijk verschil geldt", "boven de grens van"). Schrijf alleen wat er staat en wat het betekent, in gewone taal.
